    ...
    def __init__(self, sensor_type):
        ...
        for key in sensor_types:
            if key == sensor_type:
                ...
                self.manufacturer_id = sensor_types[key]['manufacturer_id']
                # support 1 payload only
                self.payload_name = sensor_types[key]["ble_config"]["payloads"][0]['name']
        print(self.name, self.manufacturer_id)
