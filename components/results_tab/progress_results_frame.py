...
class ProgressResultsFrame(CTkFrame):
    def __init__(self, master, console, params, **kwargs):
        ...
        self.loading_progress_frame.grid(row=0, column=0, sticky="nsew", padx=20, pady=20)

        self.sym_progress_frame = CTkFrame(self, fg_color="transparent")
        self.sym_progress_frame.grid(row=0, column=1, sticky="nsew", padx=20, pady=20)

        self.off_progress_frame = CTkFrame(self, fg_color="transparent")
        self.off_progress_frame.grid(row=0, column=2, sticky="nsew", padx=20, pady=20)

        self.absorbtion_frame = CTkFrame(self, fg_color="transparent")
        self.absorbtion_frame.grid(row=0, column=3, sticky="nsew", padx=20, pady=20)
        ...
        self.loading_progress_label.grid(row=0, column=0, sticky="nsew", padx=5)
        ...
        self.loading_progress_value_label.grid(row=0, column=1, sticky="nswe", padx=5)
        ...
        self.sym_progress_label.grid(row=0, column=0, sticky="nswe", padx=5)
        ...
        self.sym_progress_value_label.grid(row=0, column=2, sticky="nswe", padx=5)
        
        self.off_progress_label = CTkLabel(self.off_progress_frame, text=f'Off Loading:', 
                                           font=CTkFont(size=28, weight="bold"), text_color="#EF5DA8")
        self.off_progress_label.grid(row=0, column=0, sticky="nsew", padx=5)
        ...
        self.off_progress_value_label.grid(row=0, column=2, sticky="nswe", padx=5)

        self.ab_progress_label = CTkLabel(self.absorbtion_frame, text=f'Absorbtion:', 
                                           font=CTkFont(size=28, weight="bold"), text_color="#EF5DA8")
        self.ab_progress_label.grid(row=0, column=0, sticky="nsew", padx=5)
  
        self.ab_progress_value_label = CTkLabel(self.absorbtion_frame, text=f'30%', image=self.up_icon, compound="left",
                                                 font=CTkFont(size=32, weight="bold"), text_color="#FFFFFF")
        self.ab_progress_value_label.grid(row=0, column=2, sticky="nswe", padx=5)
